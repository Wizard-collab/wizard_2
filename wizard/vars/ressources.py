...
_tasks_icon_ = os.path.join(_icons_path_, 'tasks.png')
_tasks_process_icon_ = os.path.join(_icons_path_, 'tasks_process.png')
_tasks_done_icon_ = os.path.join(_icons_path_, 'tasks_done.png')
_running_softwares_icon_ = os.path.join(_icons_path_, 'running_softwares.png')
...
_no_connection_info_ = os.path.join(_icons_path_, 'info_no_connection.png')
...
_gold_icon_ = os.path.join(_icons_path_, 'gold.png')
_silver_icon_ = os.path.join(_icons_path_, 'silver.png')
_bronze_icon_ = os.path.join(_icons_path_, 'bronze.png')
_ranking_icon_ = os.path.join(_icons_path_, 'ranking_icon.png')
...
_state_todo_ = os.path.join(_icons_path_, 'state_todo.png')
