...
class header_widget(QtWidgets.QFrame):
    ...
    show_artefacts = pyqtSignal(object)
    ...
    def build_ui(self):
        ...
        self.artefacts_action = self.window_action.addAction(QtGui.QIcon(ressources._artefacts_icon_), "Artefacts")
    ...
    def connect_functions(self):
        ...
        self.whatsnew_action.triggered.connect(self.show_whatsnew.emit)
        ...
        self.artefacts_action.triggered.connect(self.show_artefacts.emit)
