...
class overview_widget(QtWidgets.QWidget):
	...
	def build_ui(self):
		...
		self.progress_widget.setSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
...
class progress_overview_widget(QtWidgets.QFrame):
	...
	def build_ui(self):
		...
		for domain in assets_vars._domains_list_no_lib_:
			...
			domain_header_layout.addSpacerItem(QtWidgets.QSpacerItem(10,0,QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed))
			...
			domain_stages_widget_layout.setContentsMargins(30,0,0,0)
			...
			for stage in assets_vars._stages_list_[domain]:
				...
				main_widget_layout.addSpacerItem(QtWidgets.QSpacerItem(10, 0, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed))
				...
				main_widget_layout.addSpacerItem(QtWidgets.QSpacerItem(0, 0, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed))
