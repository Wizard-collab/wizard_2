...
class footer_widget(QtWidgets.QFrame):
    ...
    def build_ui(self):
        ...
        self.icon_label.setPixmap(QtGui.QIcon(
            ressources._info_icon_).pixmap(22))
        ...
        self.icon_label.setFixedSize(QtCore.QSize(22, 22))
        self.icon_label.setPixmap(QtGui.QIcon(
            ressources._chip_icon_).pixmap(22))
        self.main_layout.addWidget(self.icon_label)
        ...
        gui_utils.application_tooltip(
            self.team_connection_button, "Team connection status")
        self.team_connection_button.setIcon(
            QtGui.QIcon(ressources._team_connection_off_))
        ...
        gui_utils.application_tooltip(
            self.refresh_ui_button, "Manually refresh the ui")
        ...
        gui_utils.application_tooltip(
            self.locks_button, "Show locked work environments")
        ...
        gui_utils.application_tooltip(
            self.softwares_button, "Show running work environments")
        self.softwares_button.setIcon(QtGui.QIcon(
            ressources._running_softwares_icon_))
        ...
        gui_utils.application_tooltip(
            self.task_manager_button, "Show task manager")
        ...
        gui_utils.application_tooltip(
            self.production_manager_button, "Show production manager")
        self.production_manager_button.setIcon(
            QtGui.QIcon(ressources._production_manager_icon_))
        ...
        gui_utils.application_tooltip(
            self.wall_button, "Show notification wall")
    ...
    def set_team_connection(self, team_connection):
        if team_connection:
            self.team_connection_button.setIcon(
                QtGui.QIcon(ressources._team_connection_on_))
        else:
            self.team_connection_button.setIcon(
                QtGui.QIcon(ressources._team_connection_off_))
    ...
    def connect_functions(self):
        ...
        self.task_manager_button.clicked.connect(
            self.show_subtask_manager.emit)
        self.production_manager_button.clicked.connect(
    ...
    def update_console_button(self, notification):
        if notification == 'warning':
            self.console_button.setIcon(QtGui.QIcon(
                ressources._console_warning_icon_))
        elif notification == 'error':
            self.console_button.setIcon(
                QtGui.QIcon(ressources._console_error_icon_))
        elif notification == 'info':
            self.console_button.setIcon(
                QtGui.QIcon(ressources._console_info_icon_))
        else:
            self.console_button.setIcon(QtGui.QIcon(ressources._console_icon_))

    def update_wall_button(self, notification):
        if notification:
            self.wall_button.setIcon(QtGui.QIcon(
                ressources._wall_notification_icon_))
        else:
            self.wall_button.setIcon(QtGui.QIcon(ressources._wall_icon_))

    def update_subtask_manager_button(self, status):
        if status == 'process':
            self.task_manager_button.setIcon(
                QtGui.QIcon(ressources._tasks_process_icon_))
        elif status == 'done':
            self.task_manager_button.setIcon(
                QtGui.QIcon(ressources._tasks_done_icon_))
        else:
            self.task_manager_button.setIcon(
                QtGui.QIcon(ressources._tasks_icon_))
...
class tooltip_widget(QtWidgets.QFrame):
    ...
    def build_ui(self):
        ...
        self.icon_label.setFixedSize(QtCore.QSize(22, 22))
        self.icon_label.setPixmap(QtGui.QIcon(
            ressources._bulb_icon_).pixmap(22))
        self.main_layout.addWidget(self.icon_label)

        self.main_label = gui_utils.ElidedLabel('Tooltips')
        gui_utils.application_tooltip(
            self.main_label, "Come here if you're lost")
...
class script_bar(QtWidgets.QFrame):
    ...
    def build_ui(self):
        ...
        self.icon_label.setFixedSize(QtCore.QSize(22, 22))
        self.icon_label.setPixmap(QtGui.QIcon(
            ressources._python_icon_).pixmap(22))
        self.main_layout.addWidget(self.icon_label)
