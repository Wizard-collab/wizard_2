...
class render_time_manager_widget(QtWidgets.QWidget):
    ...
    def build_ui(self):
        ...
        self.vertical_layout.addSpacerItem(QtWidgets.QSpacerItem(0,0,QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Expanding))
...
class main_progress_widget(QtWidgets.QFrame):
    ...
    def refresh(self):
        ...
        self.infos_label.setText(f"{rendered_frames} frames rendered / {all_frames} frames\n{frames_left} frames to render")
...
class settings_subwidget(QtWidgets.QFrame):
    ...
    def build_ui(self):
        ...
        self.render_nodes_icon.setPixmap(QtGui.QIcon(ressources._render_node_icon_).pixmap(30))
        ...
        self.machine_count_spinBox.setButtonSymbols(QtWidgets.QSpinBox.ButtonSymbols.NoButtons)
        self.machines_count_settings_layout.addWidget(self.machine_count_spinBox)

        self.machines_count_label = QtWidgets.QLabel('render nodes')
        self.machines_count_settings_layout.addWidget(self.machines_count_label)

        self.machines_count_settings_layout.addSpacerItem(QtWidgets.QSpacerItem(0,0,QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed))
        ...
        self.render_time_icon.setPixmap(QtGui.QIcon(ressources._render_time_icon_).pixmap(30))
        ...
        self.render_time_spinBox.setButtonSymbols(QtWidgets.QSpinBox.ButtonSymbols.NoButtons)
        ...
        self.render_time_settings_layout.addSpacerItem(QtWidgets.QSpacerItem(0,0,QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed))
...
class infos_subwidget(QtWidgets.QFrame):
    ...
    def build_ui(self):
        ...
        self.header_layout.addRow(self.render_nodes_icon, self.render_nodes_label)

        self.frames_left_icon = QtWidgets.QLabel()
        self.frames_left_icon.setPixmap(QtGui.QIcon(ressources._frame_icon_).pixmap(30))

        self.frames_left_label = QtWidgets.QLabel()
        self.header_layout.addRow(self.frames_left_icon, self.frames_left_label)
        ...
        self.total_time_icon.setPixmap(QtGui.QIcon(ressources._render_time_icon_).pixmap(30))
    ...
    def refresh(self):
        ...
        mean_render_time = project.get_mean_render_time()
        render_nodes_number = project.get_render_nodes_number()
        estimated_render_time = tools.convert_seconds_to_string_time((frames_left*mean_render_time)/render_nodes_number)

        self.render_nodes_label.setText(f"{render_nodes_number} render nodes")
        self.frame_time_label.setText(f"{tools.convert_seconds_to_string_time(mean_render_time)}/frame")
        self.total_time_label.setText(f"{estimated_render_time} to render all ( With {render_nodes_number} render nodes)")
...
class success_subwidget(QtWidgets.QFrame):
    ...
    def build_ui(self):
        ...
        self.time_left_bar.setStyleSheet('QProgressBar{background-color:transparent;}QProgressBar::chunk{background-color:#ffffff;}')
        ...
        self.render_time_bar.setStyleSheet('QProgressBar{background-color:transparent;}QProgressBar::chunk{background-color:#ffffff;}')
        ...
        self.machines_icon_label.setPixmap(QtGui.QIcon(ressources._render_node_icon_).pixmap(30))
        ...
        self.machines_optimisation_label.setSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        self.grid_layout.addWidget(self.machines_optimisation_label, 1, 2)

        self.render_time_icon_label = QtWidgets.QLabel()
        self.render_time_icon_label.setPixmap(QtGui.QIcon(ressources._render_time_icon_).pixmap(30))
    ...
    def refresh(self):
        ...
        mean_render_time = project.get_mean_render_time()
        render_nodes_number = project.get_render_nodes_number()
        render_time_1_machine = tools.convert_seconds_to_string_time(frames_left*mean_render_time)
        estimated_render_time = tools.convert_seconds_to_string_time((frames_left*mean_render_time)/render_nodes_number)
        MACHINES_REQUIRED_TO_FINISH = round((frames_left*mean_render_time)/time_left)
        ...
        self.time_left_label.setText(f"{tools.convert_seconds_to_string_time(time_left)} until deadline")
        self.render_time_label.setText(f"{tools.convert_seconds_to_string_time(render_time)} to render all")
        ...
        if render_time < time_left:
            ...
            self.render_time_bar.setStyleSheet('QProgressBar{background-color:transparent;}QProgressBar::chunk{background-color:#7ca657;}')
        else:
            ...
            self.render_time_bar.setStyleSheet('QProgressBar{background-color:transparent;}QProgressBar::chunk{background-color:#d16666;}')

        if MACHINES_REQUIRED_TO_FINISH < render_nodes_number:
            self.machines_status_label.setPixmap(QtGui.QIcon(ressources._down_arrow_).pixmap(30))
            self.machines_optimisation_label.setText(f"You can decrease the render nodes number to {MACHINES_REQUIRED_TO_FINISH}")
        elif MACHINES_REQUIRED_TO_FINISH > render_nodes_number:
            self.machines_status_label.setPixmap(QtGui.QIcon(ressources._up_arrow_).pixmap(30))
            self.machines_optimisation_label.setText(f"You can increase the render nodes number to {MACHINES_REQUIRED_TO_FINISH}")
        else:
            self.machines_status_label.setPixmap(QtGui.QIcon(ressources._check_icon_).pixmap(30))
            self.machines_optimisation_label.setText(f"Render nodes count looks optimised")

        if RENDER_TIME_REQUIRED_TO_FINISH < mean_render_time:
            self.render_time_status_label.setPixmap(QtGui.QIcon(ressources._down_arrow_).pixmap(30))
            self.render_time_optimisation_label.setText(f"You can decrease the render time to {tools.convert_seconds_to_string_time(RENDER_TIME_REQUIRED_TO_FINISH)} / frame")
        else:
            self.render_time_status_label.setPixmap(QtGui.QIcon(ressources._check_icon_).pixmap(30))
            self.render_time_optimisation_label.setText(f"Render time looks optimised")
