...
class project_general_preferences_widget(QtWidgets.QWidget):
    ...
    def refresh(self):
        ...
        project_row = repository.get_project_row_by_name(
    ...
    def get_random_image(self):
        ...
        repository.modify_project_image(
            environment.get_project_name(), image_file)
        self.refresh()
    ...
    def build_ui(self):
        ...
        self.infos_frame.setSizePolicy(
        ...
        self.project_name_data.setTextInteractionFlags(
            QtCore.Qt.TextInteractionFlag.TextSelectableByMouse)
        self.infos_sublayout.addRow(
            self.project_name_label, self.project_name_data)
        ...
        self.project_path_data.setTextInteractionFlags(
            QtCore.Qt.TextInteractionFlag.TextSelectableByMouse)
        self.infos_sublayout.addRow(
            self.project_path_label, self.project_path_data)
        ...
        self.frame_rate_frame.setSizePolicy(
            QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        ...
        self.frame_rate_buttons_widget.setLayout(
            self.frame_rate_buttons_layout)
        self.frame_rate_layout.addWidget(self.frame_rate_buttons_widget)

        self.frame_rate_buttons_layout.addSpacerItem(QtWidgets.QSpacerItem(
            0, 0, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed))
        ...
        self.format_frame.setSizePolicy(
            QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        ...
        self.format_layout.addSpacerItem(QtWidgets.QSpacerItem(
            0, 0, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed))
        ...
        self.format_buttons_layout.addSpacerItem(QtWidgets.QSpacerItem(
            0, 0, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed))
        ...
        self.OCIO_buttons_layout.addSpacerItem(QtWidgets.QSpacerItem(
            0, 0, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed))
        ...
        self.deadline_frame.setSizePolicy(
            QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed)
        ...
        self.deadline_buttons_layout.addSpacerItem(QtWidgets.QSpacerItem(
            0, 0, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Fixed))
