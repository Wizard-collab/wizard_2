...
class user_widget(QtWidgets.QFrame):
    ...
    def build_ui(self):
        ...
        self.level_icon.setPixmap(QtGui.QIcon(
            ressources._level_icon_).pixmap(22))
        ...
        self.coins_icon.setPixmap(QtGui.QIcon(
            ressources._coin_icon_).pixmap(22))
        ...
        self.life_icon.setPixmap(QtGui.QIcon(
            ressources._heart_icon_).pixmap(22))
        ...
        self.admin_badge_label.setPixmap(
            QtGui.QIcon(ressources._admin_badge_).pixmap(22))
    ...
    def refresh(self):
        ...
        pm = gui_utils.mask_image(image.convert_str_data_to_image_bytes(
            user_row['profile_picture']), 'png', 28, custom_radius=14)
