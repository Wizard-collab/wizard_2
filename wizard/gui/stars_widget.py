...
class rate_widget(QtWidgets.QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.image_bg = gui_utils.QIcon_from_svg(
            ressources._star_icon_, '#24242b').pixmap(12)
        self.image_hover = gui_utils.QIcon_from_svg(
            ressources._star_icon_, '#ffdb4a').pixmap(12)
        self.image_rate = gui_utils.QIcon_from_svg(
            ressources._star_icon_, '#e0a628').pixmap(12)
        self.stars_list = []
        self.rate = 0
