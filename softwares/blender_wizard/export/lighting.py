...
def main(comment=''):
    ...
    try:
        ...
        collections_dic = wizard_tools.get_export_grps('lighting_GRP')
        ...
        for collection_name in collections_dic.keys():
            ...
            wizard_export.export('lighting', export_name, exported_string_asset, export_GRP_list, comment=comment)
    except:
