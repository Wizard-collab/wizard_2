...
def reference_modeling(reference_dic):
    import_file(reference_dic['namespace'], reference_dic['files'],
...
def update_modeling(reference_dic):
    update_file(reference_dic['namespace'], reference_dic['files'],
                'MODELING', 'modeling', reference_dic['string_stage'])
    append_wizardTags_to_guerillaTags(reference_dic['namespace'])
...
def reference_shading(reference_dic):
    import_file(reference_dic['namespace'], reference_dic['files'],
                'SHADING', 'shading', reference_dic['string_stage'])
...
def reference_cfx(reference_dic):
    import_file(reference_dic['namespace'], reference_dic['files'],
                'CFX', 'cfx', reference_dic['string_stage'])
    append_wizardTags_to_guerillaTags(reference_dic['namespace'])
...
def reference_fx(reference_dic):
    import_file(reference_dic['namespace'], reference_dic['files'],
                'FX', 'fx', reference_dic['string_stage'])
    append_wizardTags_to_guerillaTags(reference_dic['namespace'])
...
def reference_lighting(reference_dic):
    import_file(reference_dic['namespace'], reference_dic['files'],
                'LIGHTING', 'lighting', reference_dic['string_stage'])
    append_wizardTags_to_guerillaTags(reference_dic['namespace'])
...
def create_vdb_ref(namespace, files_list, GRP):
    sequence_files_list = wizard_tools.convert_files_list_to_sequence(
        files_list)
