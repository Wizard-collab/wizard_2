...
def main(comment=''):
    ...
    try:
        ...
        wizard_export.export(stage_name='rigging', export_name=export_name, exported_string_asset=exported_string_asset, out_node='wizard_rigging_output', comment=comment)
    except:
