    ...
    try:
        ...
        for out_node_name in out_nodes_dic.keys():
            ...
            wizard_export.trigger_before_export_hook(
                'fx', exported_string_asset)
            wizard_export.export(stage_name='fx', export_name=export_name, exported_string_asset=exported_string_asset,
                                 out_node=out_node_name, frange=frange, comment=comment, prepare_only=prepare_only)
    except:
