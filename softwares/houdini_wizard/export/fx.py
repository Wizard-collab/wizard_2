...
def main(frange, comment=''):
    ...
    try:
        ...
        for out_node_name in out_nodes_dic.keys():
            ...
            wizard_export.export(stage_name='fx', export_name=export_name, exported_string_asset=exported_string_asset, out_node=out_node_name, frange=frange, comment=comment)
    except:
